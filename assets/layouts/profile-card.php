        ...
        <div class='card card-profile text-center box-shadow bg-white'>
            ...
            <?php if (isset($_SESSION['authorization'])) { ?>
                ...
                <div class='card-block'>
                    ...
                    <a href='../profile'>
                        <img src='../assets/uploads/users/<?php echo $_SESSION['profile_image']; ?>' class='card-img-profile'>Profile Image
                    </a>
                    ...
                    <h4 class='card-title'>
                        ...
                        <small class="text-muted mt-2">
                            <?php echo $_SESSION['first_name'] . ' ' . $_SESSION['last_name']; ?>First Name and Last Name
                        </small>

                        <small class="text-muted mt-4">
                            <?php echo $_SESSION['headline']; ?> Headline
                        </small>
